...
-- >>>>>>>> shade2/module.hsp:234 	#deffunc skillMod int sid,int c,int a ..
   ...
   chara:emit("elona_sys.on_gain_skill_exp", { skill_id = skill, base_exp_amount = exp, actual_exp_amount = exp, level_delta = level_delta })
...
function Skill.gain_skill_exp(chara, skill, base_exp, exp_divisor_stat, exp_divisor_level)
   ...
   chara:emit("elona_sys.on_gain_skill_exp", { skill_id = skill, base_exp_amount = base_exp, actual_exp_amount = exp, level_delta = level_delta })
...
local function refresh_weight(chara)
   ...
   print("IT", chara.inventory_weight_type, weight, max_weight, max_weight / 2)
