return {
  ...
  return ("Welcome to the Thieves Guild, %s %s... Please come in.")
  :format(_1, _2)
end,
          new_quota = function(_1)
  return ("Alright. The Thieves Guild wants you to put stolen goods into circulation. Steal some goods and sell them to any vendors. When the sum of your earning reaches %s gold pieces, we will think about your promotion.")
  :format(_1)
end
        },
        nonmember = {
  ...
  return ("I hope we can talk again sometime, %s!")
  :format(_1)
end,
        quest = {
          begin = {
      ...
      doria = {
        member = {
          dialog = function(_1, _2)
  return ("Welcome to the Fighters Guild, %s %s... Please come in.")
  :format(_1, _2)
end,
          new_quota = function(_1, _2)
  return ("There's a task for you. Go find and slay %s %s. Then we will think about your promotion.")
  :format(_1, _2)
end
        },
        nonmember = {
          ...
          quota = function(_1, _2)
  return ("You still need to slay %s more %s.")
  :format(_1, _2)
end,
          ...
          want_to_join = {
            ...
            _1 = function(_1, _2)
  return ("The task given to you is this. Find and slay %s %s. When you complete this, talk to me again.")
  :format(_1, _2)
end
          }
        }
  ...
  :format(_1)
          ...
          pledge_strength = {
            dialog = {
              ...
              _3 = function(_1)
  return ("Your duty will be to penetrate into Lesimas and make contact with <Karam>. In the last report we received from him, he told us he was on the 16th floor. If you can find him, perhaps we can get this excavation back on track. Godspeed, %s, find out what happened to <Karam>.")
  :format(_1)
end
            },
        ...
        investigation = {
          ...
          dialog = function(_1)
  return ("%s, how's your investigation going? Ask anything you'd like to know.")
  :format(_1)
end,
          inferno = {
  ...
  :format(_1)
        ...
        stones = {
          dialog = {
            _0 = function(_1)
  return ("I've been waiting for you to return, %s. I hope that Karam is... no, I can tell just by looking at you. Then our rescue attempt was too little too late.")
  :format(_1)
end,
      ...
      gilbert = {
        ...
        quest = {
          ...
          dialog = {
            _0 = function(_1)
  return ("By Opatos! You are the famous %s, are you not? I have a favor I'd like to ask of someone like you. ")
  :format(_1)
end,
      ...
      lily = {
        ...
        progress = {
          ...
          end_life = {
            ...
            dialog = {
              _0 = function(_1)
  return ("%s, I have... I have one final request. Take this knife and... *weep*. If Pael's friends saw me like this, they'd run in fear and treat her with fear and suspicion. As long as she can be happy, I...")
  :format(_1)
end,
          ...
          last = {
            _0 = function(_1)
  return ("%s, I'm sorry you have to see me this way... please don't turn away... don't run. It seems my disease has already progressed too far... my twisted and hideous body... I can never return to normal... the disease is too advanced now.")
  :format(_1)
end,
          ...
          late = function(_1)
  return ("It's good to see you, %s. Hmm? You say I look happy? Hehe, just before you arrived Pael made a snowman outside. She said she made it with her friends. I haven't seen her smile like that since her father died. When I see that snowman through the window, I feel a joy I cannot describe to you.")
  :format(_1)
end,
      ...
      lomias = {
        after = {
          ...
          get_out = {
            dialog = {
              _0 = function(_1)
  return ("%s is right. The time left for us is scarce. We need to depart, Lomias.")
  :format(_1)
end,
        ...
        begin = {
          ...
          _4 = function(_1)
  return ("...yes, it's a bad habit of mine. Well, %s...")
  :format(_1)
end,
          easter_egg = {
          ...
          movement = {
            ate = {
              dialog = {
                ...
                _2 = "Now, allow me to explain how to act by using the [z] key."
              },
              response = "What!"
            },
            choices = {
      ...
      loyter = {
        ...
        quest = {
          ...
          dialog = {
            _0 = function(_1)
  return ("Hey you! Hold up! I've seen your face before punk... %s... Ah yes... I remember now. You've been making quite a name for yourself throughout Tyris, haven't you?")
  :format(_1)
end,
  ...
  :format(_1)
      ...
      miral = {
        ...
        upgrade_cart = {
          ...
          dialog = function(_1)
  return ("Upgrade your cart? It's not something I get excited about but if you can give me %s small medals, I'll think about it.")
  :format(_1)
end,
          give = {
            dialog = "Here you are.",
            limit_increased = function(_1)
  return ("Your cart's weight limit has increased by %s.")
  :format(_1)
end
          },
          go_back = "Huh."
      ...
      pael = {
        ...
        give = {
          ...
          dialog = function(_1)
  return ("R-Really? Mommy, mommy! %s gave us a cure! Are you gonna be ok now?")
  :format(_1)
end,
          do_not_have = "Liar!",
        ...
        progress = {
          ...
          _1 = function(_1)
  return ("Thanks %s, you're the best! Mommy's getting better and better.")
  :format(_1)
end,
          _2 = function(_1)
  return ("Ah, hi %s. Thanks to you Mommy's been getting better! But... it still looks like she needs more time before she's really healthy.")
  :format(_1)
end,
          ...
          _4 = function(_1)
  return ("%s! It's mommy... something's wrong! Suddenly she started acting strange and... now her body is changing and... oh gods...")
  :format(_1)
end,
          _5 = "Mommy! Mommy are you okay? Mommy?",
          _6 = function(_1)
  return ("%s, mommy has something to say to you.")
  :format(_1)
end
        }
      },
      ...
      raphael = {
        bring_wife = {
          ...
          this_one = {
            come_along = function(_1)
  return ("So... this is your wife eh? %s is her name? Don't be embarrassed, come along!")
  :format(_1)
end,
      ...
      renton = {
        ...
        quest = {
          brought = function(_1)
  return ("You've brought %s book%s, just for my sake? You have my thanks. If I recall correctly, there are four volumes in the series. If you can find all four for me I'll find some way to thank you. ")
  :format(_1, s(_1))
end,
          brought_all = {
            dialog = {
      ...
      rogue_boss = {
        ambush = {
          ...
          dialog = function(_1, _2)
  return ("Halt, halt, traveler. You're a quite fortunate one. Before you is the renowned band of legendary brigands \"%s\" that the mere mention of its name is enough to silence a naughty child. Yet we will spare your life for only a toll of %s gold pieces and your cargos. Quite fortunate indeed.")
  :format(_1, _2)
end,
  ...
  :format(basename(_1))
      ...
      strange_scientist = {
        ...
        saved_count = function(_1, _2)
  return ("You have saved little sister %s times and killed %s times.")
  :format(_1, _2)
end,
        turn_over = {
      ...
      xabi = {
        early = {
          ...
          _1 = function(_1)
  return ("I see... then what we feared has indeed come to pass. If evil has set its sights on the artifact hidden within the depths of Lesimas, then for the honor of our King we are bound to stop it... You must be tired, %s. Give me a moment to prepare appropriate compensation for your efforts today.")
  :format(_1)
end
        },
