return {
  trait = {
    ...
    _202 = {
      negative = {
        ...
        levels = {
          _0 = function(_1)
  return ("あなたの顔はただれている[魅力%s]")
  :format(_1)
end,
          _1 = function(_1)
  return ("あなたの顔中に蕁麻疹が出ている[魅力[CHR%s]")
  :format(_1)
end,
          _2 = function(_1)
  return ("あなたの顔は崩れかけている[魅力[CHR%s]")
  :format(_1)
end
        }
      },
    ...
    _203 = {
      negative = {
        ...
        levels = {
          _0 = function(_1)
  return ("あなたの足の裏は蹄になっている[足装備不可 速度+%s]")
  :format(_1)
end
        }
      },
  ...
  :format(_1, _2)
    ...
    _205 = {
      negative = {
        ...
        levels = {
          _0 = function(_1)
  return ("あなたの背中には羽がある[背中装備不可 重量-20% 速度+%s]")
  :format(_1)
end
        }
      },
    ...
    _206 = {
      negative = {
        ...
        levels = {
          _0 = function(_1, _2)
  return ("あなたの首はもの凄く太い[首装備不可 魅力%s PV+%s]")
  :format(_1, _2)
end
        }
      },
    ...
    _207 = {
      negative = {
        ...
        levels = {
          _0 = function(_1, _2)
  return ("あなたは殺戮に飢えている[DV%s ダメージ修正+%s]")
  :format(_1, _2)
end
        }
      },
  ...
  return ("あなたの頭は巨大化している[耐久%s 器用%s 習得+%s 意思+%s]")
  :format(_1, _2, _3, _4)
end
        }
      },
  ...
  :format(_1)
    ...
    _212 = {
      negative = {
        ...
        levels = {
          _0 = function(_1)
  return ("あなたは痴呆になっている[MP-15% 魔力%s]")
  :format(_1)
end
        }
      },
    ...
    _213 = {
      negative = {
        ...
        levels = {
          _0 = function(_1, _2)
  return ("あなたは重い甲殻で覆われている[PV+%s 速度%s]")
  :format(_1, _2)
end
        }
      },
