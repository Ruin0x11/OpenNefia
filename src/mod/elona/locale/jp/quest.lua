            ...
            _1 = {
               ...
               desc = function(player, speaker, params)
                  return ("どうしようもなく肉が食べたい%s！そう%s、料理は%sがいい%s。報酬は%s%s！")
                     :format(noda(speaker), dana(speaker), params.objective, na(speaker), params.reward, da(speaker))
               end,
            },
            _2 = {
               title = "おもてなし:",
               desc = function(player, speaker, params)
                  return ("今日は大事な人と会う予定%s。肉料理をふるまいたいので、%sを料理して%s。%sを払%s。")
                     :format(da(speaker), params.objective, kure(speaker), params.reward, u(speaker))
               end
            },
         },
         _2 = {
            _1 = {
               ...
               desc = function(player, speaker, params)
                  return ("野菜がダイエットにいいのは常識%s。%sを料理して来て%s。代金は%s%s。")
                     :format(dana(speaker), params.objective, kure(speaker), params.reward, da(speaker))
               end,
            },
            _2 = {
               title = "好き嫌いの改善",
               desc = function(player, speaker, params)
                  return ("%sが依頼の報酬%s。子供がどうしても野菜を食べないので困ってい%s！%sなら食べるかも知れないので料理してきて%s。")
                     :format(params.reward, da(speaker), ru(speaker), params.objective, kure(speaker))
               end
            },
         },
         _3 = {
            _1 = {
               ...
               desc = function(player, speaker, params)
                  return ("報酬は%sで十分%s？今晩のディナーのデザートに%sが食べたくなったので、配達をお願いする%s。")
                     :format(params.reward, kana(speaker), params.objective, yo(speaker))
               end,
            },
            _2 = {
               title = "フルーツ料理",
               desc = function(player, speaker, params)
                  return ("パーティーでフルーツ料理をふるまいたい%s。%sを用意してくれれば、%sを払%s。")
                     :format(noda(speaker), params.objective, params.reward, u(speaker))
               end
            }
         },
         _4 = {
            _1 = {
               ...
               desc = function(player, speaker, params)
                  return ("甘〜いお菓子を食べたい%s！%sと引き換えに%sをあげ%s。")
                     :format(noda(speaker), params.objective, params.reward, ru(speaker))
               end,
            },
            _2 = {
               title = "子供のおやつ",
               desc = function(player, speaker, params)
                  return ("子供のおやつに%sを出そうと思っている%s。持ってきてくれれば、%sを払%s。")
                     :format(params.objective, noda(speaker), params.reward, u(speaker))
               end
            }
         },
         _5 = {
            _1 = {
               ...
               desc = function(player, speaker, params)
                  return ("報酬は%s%s。パスター、ラーメン、蕎麦…麺類をこよなく愛する%sに%sを食べさせて%s！")
                     :format(params.reward, da(speaker), ore(speaker), params.objective, kure(speaker))
               end,
            },
            _2 = {
               title = "喉ごしがたまらない",
               desc = function(player, speaker, params)
                  return ("つるんと食べられる%sを食べたい%s。%sを払うので、配達して%s。")
                     :format(params.objective, na(speaker), params.reward, kure(speaker))
               end
            }
         },
         _6 = {
            _1 = {
               ...
               desc = function(player, speaker, params)
                  return ("魚は身体に非常に良いそう%s。%sを料理して納入してくれるなら、%sを払%s。")
                     :format(da(speaker), params.objective, params.reward, u(speaker))
               end,
            },
            _2 = {
               title = "魚を食べさせたい",
               desc = function(player, speaker, params)
                  return ("子供に魚を食べさせたいのだ%s、好き嫌いが激しくなかなか食べない%s。%sなら食べられるかもしないので、料理を依頼したい%s。報酬は%sでどう%s？")
                     :format(ga(speaker), noda(speaker), params.objective, noda(speaker), params.reward, kana(speaker))
               end
            }
         },
         _7 = {
            _1 = {
               ...
               desc = function(player, speaker, params)
                  return ("%sはパン党？それともご飯党%s？%sは断然パンがいい%s。%sと引き換えに%sを料理して%s。")
                     :format(kimi(speaker), kana(speaker), ore(speaker), na(speaker), params.reward, params.objective, kure(speaker))
               end,
            },
            _2 = {
               title = "ピクニックのお供",
               desc = function(player, speaker, params)
                  return ("報酬は%s、これ以上は出せない%s。明日のピクニックに%sを持って行きたいので、よろしく%s！")
                     :format(params.reward, yo(speaker), params.objective, tanomu(speaker))
               end
            }
         },
         _8 = {
            _1 = {
               ...
               desc = function(player, speaker, params)
                  return ("新しい料理を研究している%s。参考にする料理として、%sと引き換えに、%sを持ってきて%s。")
                     :format(noda(speaker), params.reward, params.objective, kure(speaker))
               end,
            },
            _2 = {
               title = "美味しいものが食べたい",
               desc = function(player, speaker, params)
                  return ("%sが食べたくなった%s。料理を届けてくれれば、報酬として%sを払%s。")
                     :format(params.objective, yo(speaker), params.reward, u(speaker))
               end
            },
         }
      },
            ...
            _1 = {
               ...
               desc = function(player, speaker, params)
                  return ("あまり大きな声ではいえない%s、重要な使者を%sまで無事届ける必要が%s。報酬は%s%s。%sの首がかかってい%s。絶対にしくじらないで%s！")
                     :format(ga(speaker), params.map, aru(speaker), params.reward, da(speaker), ore(speaker), ru(speaker), kure(speaker))
               end,
            },
            _2 = {
               title = "美しすぎる人",
               desc = function(player, speaker, params)
                  return ("美しすぎるのも罪なもの%s。%sの恋人が、以前交際を断った変質者に狙われて困っている%s。危険な旅になるだろう%s、%sと引き換えに、%sまで無事に護衛して%s。")
                     :format(dana(speaker), ore(speaker), noda(speaker), ga(speaker), params.reward, params.map, kure(speaker))
               end,
            },
            _3 = {
               title = "暗殺を防げ",
               desc = function(player, speaker, params)
                  return ("あの方が、命を狙われているのは知っている%s？これは危険な依頼%s。%sに到着するまで護衛を全うしてくれれば、報酬に%sを出す%s。")
                     :format(daro(speaker), da(speaker), params.map, params.reward, yo(speaker))
               end
            },
         },
         _1 = {
            _1 = {
               ...
               desc = function(player, speaker, params)
                  return ("とにかく大至急%sまで送ってもらいたい人がいる%s。報酬は%s。くれぐれも期限を過ぎないよう注意して%s。")
                     :format(params.map, noda(speaker), params.reward, kure(speaker))
               end,
            },
            _2 = {
               title = "死ぬ前に一度だけ",
               desc = function(player, speaker, params)
                  return ("言わなくてもわかっているん%s？そう、%sの最愛の人がもうすぐ病気で死んでしまう%s。%sに、最後に思い出の街%sに連れて行ってやりたい%s！%sで引き受けて%s。")
                     :format(daro(speaker), ore(speaker), noda(speaker), params.map, params.map, noda(speaker), params.reward, kure(speaker))
               end,
            },
            _3 = {
               title = "手遅れにならないうちに",
               desc = function(player, speaker, params)
                  return ("大変%s！%sの親父がもの凄い猛毒に犯されてしまった%s！%s、%sに住むといわれる名医まで、大至急連れて行って%s！%sの全財産ともいうべき%sを謝礼に用意して%s！")
                     :format(da(speaker), ore(speaker), noda(speaker), tanomu(speaker), params.map, kure(speaker), ore(speaker), params.reward, aru(speaker))
               end
            },
         },
         _2 = {
            _1 = {
               ...
               desc = function(player, speaker, params)
                  return ("わけあって%sまで護衛して欲しいという方がいる%s。特に狙われるようなこともないと思う%s、成功すれば%sを払う%s。冒険者にとっては、簡単な依頼%s？")
                     :format(params.map, noda(speaker), ga(speaker), params.reward, yo(speaker), dana(speaker))
               end,
            },
            _2 = {
               title = "観光客の案内",
               desc = function(player, speaker, params)
                  return ("何だか変な観光客に付きまとわれて、困っている%s！手間賃として%sを払うから、やっこさんを%sあたりまで案内してやって%s。")
                     :format(noda(speaker), params.reward, params.map, kure(speaker))
               end,
            },
            _3 = {
               title = "簡単な護衛",
               desc = function(player, speaker, params)
                  return ("%sの大の仲良しの親戚が%sに行きたがってい%s。生憎今は手を離せないので、期限内に無事送ってもらえれば、お礼に%sを払う%s。")
                     :format(ore(speaker), params.map, ru(speaker), params.reward, yo(speaker))
               end
            },
         }
      }
      ...
      _1 = {
         ...
         desc = function(player, speaker, params)
            return ("森が危険になってい%s。近辺の森にモンスターが発生したよう%s。%sを出すので、誰か退治して%s。")
               :format(ru(speaker), da(speaker), params.reward, kure(speaker))
         end,
      ...
      _2 = {
         ...
         desc = function(player, speaker, params)
            return ("%sを報酬として払%s。ある場所の魔物どもを退治してもらいたい%s。")
               :format(params.reward, u(speaker), noda(speaker))
         end,
      },
      _3 = {
         title = "家の周りのモンスター",
         desc = function(player, speaker, params)
            return ("自宅の近辺にモンスターが出没して困っている%s。退治してくれるなら、報酬として%sを払%s。")
               :format(noda(speaker), params.reward, u(speaker))
         end
      }
   },
   huntex = {
      ...
      _1 = {
         ...
         desc = function(player, speaker, params)
            return ("恋人へのプレゼントはなにがいい%s？とりあえず報酬に%sを払うので、%sを調達してきて%s。")
               :format(kana(speaker), params.reward, params.objective, kure(speaker))
         end,
      },
      _2 = {
         title = "自分へのプレゼント",
         desc = function(player, speaker, params)
            return ("最近ちょっといいことがあったので、自分に%sをプレゼントしたい%s。報酬は、%sでどう%s？")
               :format(params.objective, noda(speaker), params.reward, kana(speaker))
         end,
      },
      _3 = {
         title = "子供の誕生日",
         desc = function(player, speaker, params)
            return ("報酬は%sぐらいが妥当%s。子供の誕生日プレゼントに%sがいる%s。")
               :format(params.reward, kana(speaker), params.objective, noda(speaker))
         end,
      },
      _4 = {
         title = "研究の素材",
         desc = function(player, speaker, params)
            return ("%sの研究をしてい%s。研究用のストックが尽きたので、%sで調達して来てもらえない%s？")
               :format(params.objective, ru(speaker), params.reward, kana(speaker))
         end,
      },
      _5 = {
         title = "コレクターの要望",
         desc = function(player, speaker, params)
            return ("%sのコレクションに%sが必要%s。どうか%sの報酬で依頼を受けて%s！")
               :format(ore(speaker), params.objective, da(speaker), params.reward, kure(speaker))
         end,
      },
      _6 = {
         title = "アイテムの納入",
            ...
            _1 = {
               ...
               desc = function(player, speaker, params)
                  return ("%sを配達して%s。期限内に無事に届ければ、配達先で報酬の%sを払%s。")
                     :format(params.objective, kure(speaker), params.reward, u(speaker))
               end,
            },
            _2 = {
               title = "お祝いの品",
