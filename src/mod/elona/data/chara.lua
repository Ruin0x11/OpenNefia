...
local chara = {
		...
		events = {
			{
				...
				callback = function(self, params)
					...
					-- TODO void
					if
						Sidequest.is_active_main_quest("elona.main_quest")
		...
		events = {
			{
				...
				callback = function(self, params)
					-- TODO show house
					-- TODO void
					if Sidequest.is_active_main_quest("elona.main_quest") and not save.elona.flag_fools_magic_stone then
		...
		events = {
			{
				...
				callback = function(self, params)
					-- TODO show house
					-- TODO void
					if Sidequest.is_active_main_quest("elona.main_quest") and not save.elona.flag_kings_magic_stone then
		...
		events = {
			{
				...
				callback = function(self, params)
					-- TODO show house
					-- TODO void
					if Sidequest.is_active_main_quest("elona.main_quest") and not save.elona.flag_sages_magic_stone then
		...
		events = {
			{
				...
				callback = function(self, params)
					...
					DeferredEvent.add(function()
						DeferredEvents.little_sister(x, y, map)
					end)
					-- <<<<<<<< shade2/chara_func.hsp:1715 			if cId(tc)=318:evAdd evLittleSister,cX(tc),cY(t ..
				end,
			},
		...
		events = {
			{
				...
				callback = function(self, params)
					...
					Gui.mes_c(
						"talk.unique.strange_scientist.saved_count",
						"Red",
	...
	},
	{
		...
		ai_actions = {
			sub = {
				{ id = "elona.skill", skill_id = "elona.action_impregnate" },
			},
		},
