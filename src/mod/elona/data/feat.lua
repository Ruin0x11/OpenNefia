...
end, on_bumped_into = function(self, params) self:on_open() end,
on_open = function(self, params)
   ...
   self:refresh()
end, on_close = function(self, params)
   ...
   self:refresh()
end, on_bash = function(self, params)
...
local function gen_stair(down)
   ...
   return {_type = "base.feat", _id = id, elona_id = elona_id, image = image,
      ...
      local success, map,
      was_generated = MapArea.load_map_of_entrance(self, true)
      if not success then
      ...
      return "player_turn_query"
   end, [field] = function(self, params) self:on_activate(params.chara) end}
end
...
{_type = "base.feat", _id = "map_entrance", elona_id = nil,
 image = "elona.feat_area_city", is_solid = false, is_opaque = false, params = {
   ...
   return "player_turn_query"
end, on_descend = function(self, params) self:on_activate(params.chara) end}

data:add {_type = "base.feat", _id = "pot", elona_id = 30,
...
events = {{id = "elona_sys.on_bump_into", name = "Bump into to shatter pot",
           callback = function(self, params)
   print("on_bump")
   return ElonaAction.bash(params.chara, self.x, self.y)
end}}}

data:add {_type = "base.feat", _id = "hidden_path", elona_id = 22,
...
data:add {_type = "base.feat", _id = "quest_board", elona_id = 23,
...
data:add {_type = "base.feat", _id = "voting_box", elona_id = 31,
...
data:add {_type = "base.feat", _id = "small_medal", elona_id = 32,
          image = "elona.feat_hidden", is_solid = false, is_opaque = false,
          on_search = function(self, params)
   local chara = params.chara
...
data:add {_type = "base.feat", _id = "politics_board", elona_id = 33,
