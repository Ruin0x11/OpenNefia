return {
   noafindskitten = {
      kitten_found = "You found kitten. Way to go, Noa!",

      nki = {
         "\"50 Years Among the Non-Kitten Items\", by Ann Droyd.",
         "\"Blup, blup, blup\", says the mud pot.",
         "\"Dear Noa, you may have already won our 10 MILLION DOLLAR prize...\"",
         ...
         "\"No!\" says the bit.",
         "\"Plexar was here\"",
         "\"Noa may not injure kitten, or, through inaction, ...\"",
         ...
         "A ball of yarn.",
         "A bartender growls, \"No Noas allowed!\"",
         ...
         "A bottle of crim ale! Refreshing!",
         ...
         "A Noa comedian performs here. You feel amused.",
         "A roll of duct tape.",
         ...
         "A stegosaurus, escaped from stegosaurusfindsnoa. It finds you.",
         "A stony meteorite.",
         ...
         "A tiny Noa scuttles across the floor.",
         "A tiny velvet pouch.",
         ...
         "A tube of white lithium grease. Perfect for your Noatic joints.",
         "A twist of lemon.",
         ...
         "An automated Noa-disdainer. It pretends you're not there.",
         "An automated Noa-doubter. It doesn't believe in you.",
         "An automated Noa-hater. It frowns disapprovingly at you.",
         "An automated Noa-liker. It smiles at you.",
         ...
         "Hey, Noa, leave those lists alone.",
         ...
         "It's a brand new record for Twenty Twenty!",
         ...
         "It's a grue. Fortunately, they don't like to eat Noa.",
         ...
         "It's the handheld noafindskitten game, by Tiger.",
         ...
         "Lysine, an essential amino acid. Well, maybe not for Noa.",
         ...
         "Noa should not be touching that.",
         "Run away! Run away!",
         ...
         "Something is written here in the dust. You read: \"nJaf ndQkttten\".",
         "Stimutacs.",
         ...
         "This corroded Noa is clutching a mitten.",
         ...
         "This is a remote control. Being Noa, you keep a wide berth.",
         "This is a tasty-looking banana creme pie.",
         "This is a television. On screen you see a Noa strangely similar to yourself.",
         "This is an anagram.",
         ...
         "You found netkit! Way to go, Noa!",
         "You found the marble in the oatmeal!",
         "You have new mail in /var/spool/noa",
