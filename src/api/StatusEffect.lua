...
function StatusEffect.install()
   Event.register("base.on_chara_pass_turn", "status effect turn begin", StatusEffect.proc_turn_begin)
   Event.register("base.on_chara_turn_end", "status effect turn end", StatusEffect.proc_turn_end)
end
...
function StatusEffect.proc_turn_begin(params)
   local victim = params.chara
...
function StatusEffect.proc_turn_end(params)
   local victim = params.chara
