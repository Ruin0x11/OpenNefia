...
function UiPagedList:init(x, y, items, page_size, item_height, item_offset_x, item_offset_y)
   self.x = x
   self.y = y
   self.model = PagedListModel:new(items, page_size)
...
function UiPagedList:relayout()
end

function UiPagedList:draw_select_key(i, item, key_name, x, y)
...
function UiPagedList:draw_item_text(text, i, item, x, y, x_offset)
...
function UiPagedList:draw_item(i, item, x, y)
