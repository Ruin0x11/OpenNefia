local map_tile = {
   ...
   { atlas = 1, id = 12,  name = "cracked_dirt_1" },
   { atlas = 1, id = 13,  name = "cracked_dirt_2" },
   { atlas = 1, id = 14,  name = "room_default" },
   ...
   { atlas = 1, id = 36,  name = "dark_dirt_4" },
   ...
   { atlas = 1, id = 67,  name = "tower_of_fire_tile_2" },
   { atlas = 1, id = 68,  name = "tower_of_fire_tile_3" },
   ...
   { atlas = 1, id = 528, name = "wall_stone_1_fog" },
   { atlas = 1, id = 529, name = "wall_stone_2_fog" },
   { atlas = 1, id = 530, name = "wall_stone_3_fog" },
   { atlas = 1, id = 531, name = "wall_stone_4_fog" },
   { atlas = 1, id = 532, name = "wall_stone_5_fog" },
   { atlas = 1, id = 533, name = "wall_wooden_fog" },
   { atlas = 1, id = 534, name = "wall_dirt_fog" },
   { atlas = 1, id = 535, name = "wall_dirt_dark_fog" },
   { atlas = 1, id = 536, name = "wall_pyramid_fog" },
   { atlas = 1, id = 537, name = "wall_shingled_fog" },
   { atlas = 1, id = 538, name = "wall_concrete_fog" },
   { atlas = 1, id = 539, name = "wall_concrete_light_fog" },
   { atlas = 1, id = 540, name = "wall_tower_of_fire_fog" },
   { atlas = 1, id = 541, name = "wall_forest_fog" },
   { atlas = 1, id = 542, name = "wall_stone_6_fog" },
   { atlas = 1, id = 543, name = "wall_stone_7_fog" },
